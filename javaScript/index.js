  ...
  class Goku {
    ...
    print(ctx) {
      ...
      if (gokuCount >= 0 && gokuCount <= 8) {
        ...
        ctx.drawImage(this.imgGoku, gokuSprite.posSprite[5].x_ini, gokuSprite.posSprite[5].y_ini, gokuSprite.posSprite[5].w, gokuSprite.Sprite[5].h, this.x, this.y, this.width, this.heigth);
        gokuCount = 0;
      }
    }
    moveLeft() {
